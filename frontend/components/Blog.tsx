...
export default function Blog() {
    ...
    return (
        <section id="blog" className="bg-background-alt" style={{ boxShadow: '0px 0px 16px 16px #ebebeb' }}>
                    ...
                    {posts.map((post, index) => (
                        ...
                        >
                            <div className="relative aspect-[16/10] rounded-2xl overflow-hidden mb-6 border border-border bg-white shadow-sm transition-shadow group-hover:shadow-md">
                                ...
                                />
                                {post.category && (
                                    <span className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-[10px] font-bold text-foreground uppercase tracking-widest shadow-sm">
                                        {post.category.name}
                                    </span>
                                )}
                            </div>
